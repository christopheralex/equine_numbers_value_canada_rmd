...
```{r plot horses, fig.cap="Figure 1. Horse population across all provinces betwen 1940-72.", out.width="100%", fig.width=10, fig.height=3}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption="Table 1. Maximum and minimum number of horeses per province between 1940-72")
```
